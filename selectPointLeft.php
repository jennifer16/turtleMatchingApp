  ...
  <div class="row">
          ...
          <div class="col-md-12">
                ...
                <div class="row" align="center">
                     <div class="col-md-12">
                    <img src='./Turtle/<?php echo $leftImage;?>' style="width=auto; max-height: 100vh;" id="leftImage">
                    </div>
                </div>
                ...
                <form method="post" action="doSelectPointLeft.php">
                    ...
                    <input type="hidden" name="rightName" value="<?php echo $rightImage; ?>">
                    <input type="hidden" name="turtleId" id="turtleId" value='<?php echo $turtle_id; ?>'>
                    <br>
