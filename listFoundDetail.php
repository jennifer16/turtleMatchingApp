...
$sql =  "SELECT * FROM found WHERE turtle_id='".$turtleID."'";
          ...
          <div class="card">
            ...
            <h5>แก้ไขข้อมูลเต่า</h5>
              <table id="listTurtle" class="display">
                <thead>
                <tr>
                  <th style='text-align: center;'>ครั้งที่พบ</th>
                  <th style='text-align: center;'>วันที่พบ</th>
...
<?php
                $i=1;
                 while ($row = $data->fetch_assoc()) {
                    echo "<tr>";
                    echo "<td align='center'><a href='foundDetail.php?id=".$row['found_id']."'>".$i."</a></td>";
                    echo "<td align='center'>".$row['found_date']."</td>";
                    if( $row['found_status']==0)
                        echo "<td align='center'>ยังไม่ได้รับการยืนยัน</td>";
                    else
                        echo "<td align='center'>ยืนยันข้อมูลแล้ว</td>";
