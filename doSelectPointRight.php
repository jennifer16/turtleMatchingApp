        ...
        <main class="main">
          ...
          <section class="content">
                ...
                <div class="row" align="center">
                    <div class="col-md-12">
                        <img src="<?php if($rightExists) echo "img/green.jpg"; else echo "img/red.jpg"; ?>"  style="width:30%; height:auto;"><br><br>
                        <div class="card-title">
                        <h3><?php if($rightExists) echo "ดำเนินการเสร็จสิ้น"; else echo "ไม่สามารถสร้างไฟล์ Mesh ได้ กรุณาดำเนินการอีกครั้ง"; ?></h3>
                        </div><br>
