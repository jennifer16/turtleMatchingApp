...
$sql =  "SELECT * FROM turtle WHERE turtle_id='".$turtleID."'";
            ...
            <button type="button" class="btn btn-primary" id="cropProfile">ตกลง</button>
              ...
              <form role="form" action = "doEditTurtleDetail.php" method = "POST" enctype = "multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="turtleName" name="turtleName" placeholder="ชื่อเต่า" value='<?php echo $row['turtle_name'];?>'>
                        </div>
                    </div><br>
                                    <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <input type="text" class="form-control" id="microchipCode" name="microchipCode" placeholder="รหัสอุปกรณ์ไมโครชิพ" value='<?php echo $row['turtle_microchip_code'];?>'>
                    </div>
                     <div class="col-md-4">
                    <label for="latitude">ตำแหน่งไมโครชิพ</label>
                    <input type="text" class="form-control" id="microchipPos" name="microchipPos" placeholder="ตำแหน่งติดตั้งไมโครชิพ" value='<?php echo $row['turtle_microchip_pos'];?>'>
                    </div>
                </div> <br>
                <div class="row">
                    <div class="col-md-8">
