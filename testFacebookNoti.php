...
$post = $fb->post('/' . $profile['id'] . '/notifications/',  array( 'access_token' => $_SESSION['fb_access_token'], 'href' => "https://studioxpert.com/turtleMatchingApp/",  'template' => 'Max 180 characters','ref' => 'Notification sent '.date("Y-m-d G:i:s") )); 
