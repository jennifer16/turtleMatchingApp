...
$post = $fb->api('/' . $profile['uid'] . '/notifications/', 'POST/v2.2/',  array( 'access_token' => $fb->getApp()->getAccessToken(), 'href' => "https://studioxpert.com/turtleMatchingApp/",  'template' => 'Max 180 characters','ref' => 'Notification sent '.date("Y-m-d G:i:s") )); 
